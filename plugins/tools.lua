--Begin Tools.lua :)
local SUDO = 381292768 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@tmspecial', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'special' and not Clang) or (matches[1] == "کلاسیک" and Clang)) then
...
_Sudoer And Admins special Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات کلاسیک:_
